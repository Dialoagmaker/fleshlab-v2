export function planProduction(unifiedFacts, identityFacts, marketingFacts, creativeDecisions) {
  return {
    ...
    title_policy: creativeDecisions.title_policy,
    typography_strategy: creativeDecisions.typography_strategy,
    logo_placement_strategy: creativeDecisions.logo_placement_strategy,
    composition_plan: {
    ...
    provenance: {
      ...
      title_policy: "creative_brain_authority plus user_selection",
      typography_strategy: "creative_brain_authority",
      logo_placement_strategy: "creative_brain_authority plus deterministic_fusion",
