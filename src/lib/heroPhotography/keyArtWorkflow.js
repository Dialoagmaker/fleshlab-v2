...
export function createKeyArtBrief({ campaign = {}, mood = {}, analysis = {}, format = {} }) {
  ...
  return {
    ...
    typography: "Oversized editorial hero title from Campaign Title only",
...
export function createLayoutSketch({ compositionPlan = {}, campaign = {}, format = {}, keyArtBrief = {} }) {
  ...
  return {
    ...
    elements: [
      ...
      { element: "Campaign Title", position: `${sideLabel(titleSide)} graphic field`, reason: "The user-entered title is the main marketing object, so it receives the largest controlled typography area." },
    ...
    typographyRule: "Follow the sketch; preserve every Campaign Title word exactly and only change visual presentation."
  };
}