...
export function createKeyArtBrief({ campaign = {}, mood = {}, analysis = {}, format = {} }) {
  ...
  return {
    ...
    typography: "Adaptive editorial typography from current campaign title data only",
...
export function createLayoutSketch({ compositionPlan = {}, campaign = {}, format = {}, keyArtBrief = {} }) {
  ...
  return {
    ...
    elements: [
      ...
      { element: "Campaign Title", position: `${sideLabel(titleSide)} graphic field`, reason: "The current campaign title is used verbatim when present; if cleared, this text layer is omitted." },
    ...
    typographyRule: "Follow the sketch; preserve the current campaign title exactly when present and omit it when cleared."
  };
}