...
export default function HeroPhotographyPanel({ sourceFrameFile, pipeline, targetPlatform, campaignFamily }) {
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-5">
      ...
      {privateDevelopmentActive && <div className="mt-4 rounded-lg border border-primary/40 bg-primary/10 p-3"><span className="inline-flex rounded-full bg-primary px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-primary-foreground">PRIVATE DEVELOPMENT MODE</span><p className="mt-2 text-xs text-muted-foreground">Local application verification is bypassed. External provider policies and route restrictions still apply.</p></div>}
