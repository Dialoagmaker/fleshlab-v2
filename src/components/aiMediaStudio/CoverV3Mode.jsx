...
export default function CoverV3Mode({ frame, metadata, settings, itemFileName }) {
  ...
  return (
    <Card>
      ...
      <CardContent className="p-4 pt-0">
        <CoverV3PreviewEditor frame={frame} metadata={effectiveMetadata} settings={settings} fileSuffix="key-art-v3" />
      </CardContent>
    </Card>
  );
}