...
const sliders = [
  ...
  ["titleSize", "Title font size", 50, 190, 1], ["subtitleSize", "Subtitle font size", 28, 110, 1], ["titleY", "Title vertical position", 18, 78, 1],
  ["gradientStrength", "Gradient strength", 20, 95, 1], ["borderTexture", "Border texture", 0, 100, 1], ["safeMargin", "Platform-safe margin", 3, 14, 1],
];

export default function CoverAdjustmentControls({ settings, onChange }) {
