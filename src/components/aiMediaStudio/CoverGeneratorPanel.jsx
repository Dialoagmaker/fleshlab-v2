  ...
  return (
    <div className="space-y-4">
      ...
      {creativeReady ? (
        ...
        <Card><CardContent className="p-6 text-sm text-muted-foreground">Enter the video title and choose a story frame to generate the hero image.</CardContent></Card>
      )}
    </div>
  );
}