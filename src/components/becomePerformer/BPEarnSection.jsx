...
const colorMap = {
  rose: "border-rose-600/30 bg-rose-600/8 text-rose-400",
  amber: "border-amber-500/30 bg-amber-500/8 text-amber-400",
  purple: "border-purple-600/30 bg-purple-600/8 text-purple-400",
    ...
    <section id="how-you-earn" className="py-24 px-6 bg-gradient-to-b from-[#080808] to-[#0d0505]">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {INCOME_SOURCES.map(({ emoji, title, desc, badge, color }, i) => (
            <div key={i} className="bg-[#111] border border-white/8 rounded-2xl p-6 flex flex-col gap-3 hover:border-white/15 transition-colors">
              <div className="flex items-start justify-between gap-2">
                ...
                <span className={`text-[10px] font-black uppercase tracking-widest border rounded-full px-2.5 py-0.5 ${colorMap[color]}`}>
                  {badge}
                </span>
              </div>
