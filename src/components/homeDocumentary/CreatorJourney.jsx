  ...
  return (
    <section className="mx-auto max-w-[1440px] px-5 py-24 md:px-10 md:py-32 lg:px-14">
      <div className="rounded-[42px] border border-white/10 bg-[#0d0d0d] p-8 md:p-12 lg:p-16">
        <p className="mb-5 text-[11px] font-black uppercase tracking-[0.34em] text-[#E51D2A]">Open casting</p>
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h2 className="text-6xl font-black uppercase leading-[0.82] tracking-[-0.08em] text-white md:text-8xl">Your first shoot<br />starts here.</h2>
            <p className="mt-6 max-w-xl text-xl leading-relaxed text-white/58">No experience required. No perfect body required. Just be yourself.</p>
          </div>
          <a href="/become-performer" className="inline-flex h-14 w-fit items-center justify-center rounded-full bg-[#E51D2A] px-8 text-sm font-black uppercase tracking-wide text-white transition duration-500 hover:scale-[1.02] hover:bg-[#c91822]">Apply Confidentially</a>
        </div>
