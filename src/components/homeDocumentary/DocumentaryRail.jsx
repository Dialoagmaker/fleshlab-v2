  ...
  return (
    <section id="episodes" className="px-5 py-24 md:px-10 md:py-32 lg:px-14">
      <div className="mx-auto max-w-[1440px]">
        <p className="mb-4 text-[11px] font-black uppercase tracking-[0.3em] text-[#E51D2A]">Stories, not features</p>
        <h2 className="mb-12 text-6xl font-black uppercase leading-[0.84] tracking-[-0.08em] text-white md:text-8xl">Enter the world.</h2>
