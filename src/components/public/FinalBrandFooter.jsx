    ...
    <footer className="relative overflow-hidden bg-[#040506] text-white">
      ...
      <section className="relative mx-auto max-w-[1360px] px-5 py-20 lg:px-7 lg:py-32">
        <div className="max-w-5xl">
          ...
          <h2 className="fl-condensed text-[72px] uppercase leading-[0.82] tracking-[-0.035em] md:text-[120px] lg:text-[150px]">
            REAL PEOPLE.<br />REAL DESIRE.<br /><span className="text-[#E51D2A]">REAL STORIES.</span>
          </h2>
          <p className="mt-8 max-w-2xl text-lg font-semibold leading-8 text-white/68 md:text-2xl md:leading-9">Meet the creators behind authentic amateur productions — real people building real stories, one release at a time.</p>
      ...
      <section className="relative border-y border-white/10">
        <div className="mx-auto grid max-w-[1360px] gap-12 px-5 py-14 md:py-20 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:px-7">
          <div className="max-w-xl">
            <a href="/" aria-label="FLESHLAB home" className="inline-flex transition duration-300 hover:opacity-80"><BrandLogo className="h-[74px] w-[260px] max-w-full md:h-[86px] md:w-[320px]" /></a>
            <p className="mt-8 text-[48px] font-black uppercase leading-none tracking-[-0.07em] md:text-[72px]">AMATEUR WINS.</p>
            <p className="mt-6 max-w-xl text-base leading-7 text-white/58 md:text-lg">Built around real creators, independent productions and moments that feel less polished, more human and impossible to fake.</p>
