...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Rendering Intelligence", href: "/admin/rendering-intelligence", icon: Gauge },
      { label: "Production QA", href: "/admin/production-qa", icon: ShieldCheck },
      { label: "Studio Audit", href: "/admin/studio-audit", icon: ShieldCheck },
      { label: "Certification", href: "/admin/certification", icon: BadgeCheck },
      { label: "Adult Provider Readiness", href: "/admin/adult-provider-readiness", icon: ShieldCheck },
