...
import {
  ...
  Plus, Database, AlertCircle, RefreshCw, CheckCircle2, CreditCard, TrendingUp, Activity
} from "lucide-react";
...
const QUICK_ACTIONS = [
  { label: "Live Activity",                  href: "/admin/live-activity",                   icon: Activity },
  { label: "Growth Dashboard",               href: "/admin/growth",                          icon: TrendingUp },
