      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="bg-gradient-to-r from-[#111] to-[#1a1a1a] border border-white/6 rounded-2xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <h3 className="text-white font-bold text-base">Watch exclusive content from our performers.</h3>
              <p className="text-white/40 text-sm">Join Fanclub</p>
            </div>
            <a href="/fanclub" className="shrink-0 bg-rose-600 hover:bg-rose-500 text-white font-bold px-5 py-2.5 rounded-xl text-sm transition-colors">
              Join Fanclub
            </a>
          </div>
        </div>
