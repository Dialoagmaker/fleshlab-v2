        ...
        <div className="bg-card border-b border-border">
          <div className="max-w-7xl mx-auto px-4 py-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-3xl font-bold text-white">FLESHLAB Studios News & Creator Updates</h1>
            </div>
            <p className="text-muted-foreground max-w-3xl">
              Gay adult studio news, Filipino creator spotlights, Asian gay content updates, fanclub announcements, behind-the-scenes features, guest production updates and performer stories from FLESHLAB Studios.
            </p>
