...
export default function VideosDirectTest() {
  console.log("=== VIDEOS DIRECT TEST COMPONENT ===");
  console.log("WINDOW_LOCATION_HREF", window.location.href);
  console.log("WINDOW_LOCATION_PATHNAME", window.location.pathname);
  console.log("VIDEOS_DIRECT_COMPONENT_RENDER_START");
  console.log("==================================");
  return (
    <div style={{
      minHeight: "100vh",
      ...
      VIDEOS DIRECT TEST COMPONENT IS VISIBLE · BUILD V6
