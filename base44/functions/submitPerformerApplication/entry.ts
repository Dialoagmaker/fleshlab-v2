...
Deno.serve(async (req) => {
  try {
    ...
    const application = await base44.asServiceRole.entities.GuestProductionApplication.create({
      ...
      preferred_revenue_model: payload.preferred_revenue_model || 'undecided',
      request_type: 'performer_application',
      source_page: source_page || 'become_performer',
      source_country: source_country || null,
      utm_source: payload.utm_source || null,
      utm_market: payload.utm_market || null,
      ...
      id_document_back_r2_key: payload.id_document_back_r2_key || null,
      selfie_with_id_r2_key: payload.selfie_with_id_r2_key || null,
