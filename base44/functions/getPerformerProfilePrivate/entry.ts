...
function maskPayoutDetails(method, details) {
  ...
  switch (method) {
    case 'paypal': return { ...details, paypal_email: maskEmail(details.paypal_email) };
    case 'gcash': return { ...details, mobile_number: maskPhone(details.mobile_number) };
    case 'paymaya': return { ...details, mobile_number: maskPhone(details.mobile_number) };
    case 'bank_transfer': return { ...details, account_number: maskAccount(details.account_number) };
    case 'wise': return { ...details, email: maskEmail(details.email) };
